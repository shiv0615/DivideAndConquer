...
def main():
    file_in = open(r'/Coursera/Algorithms_Part1/DivideAndConquer/Week4/KagerMincCut.txt')
    # file_in = open(r'/Users/shivswe/Machine_Learning/Algorithms_Part1/DivideAndConquer/Week4/SimpleInput.txt')
